    ...
    <section className="bg-[#0B0F14] text-white border-b-[3px] border-white/20">
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-12 md:gap-y-16">
          ...
          {/* Feature 1 */}
          <div className="flex gap-4 md:gap-6 pb-8 border-b border-white/10">
            <IconClock />
            <div>
          ...
          {/* Feature 2 */}
          <div className="flex gap-4 md:gap-6 pb-8 border-b border-white/10">
            <Gear className="w-8 h-8 md:w-10 md:h-10 text-blue-400 flex-shrink-0" />
            <div>
          ...
          {/* Feature 4 */}
          <div className="flex gap-4 md:gap-6 pt-6 md:pt-8">
            <CurrencyDollar className="w-8 h-8 md:w-10 md:h-10 text-blue-400 flex-shrink-0" />
            <div>
...
function Stat({ value, label }) {
  return (
    <div className="text-center py-14 md:py-20 px-6 border border-white/10">
...
function IconClock() {
  return (
    <svg
      className="w-8 h-8 md:w-10 md:h-10 text-blue-400 flex-shrink-0"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.5"
      viewBox="0 0 24 24"
  ...
  return (
    ...
    >
      <path
        ...
        d="M11.049 2.927l2.236 6.873h7.223l-5.845 4.247 2.236 6.873-5.85-4.246-5.85 4.246 2.236-6.873L1.59 9.8h7.223z"
      />
    </svg>
  );
}
